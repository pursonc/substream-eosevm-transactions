 ...
 */
export declare const BothRunning: <Env, Err, Err1, Err2, Elem, Done, Done1, Done2>(left: Fiber.Fiber<Either.Either<Done, Elem>, Err>, right: Fiber.Fiber<Either.Either<Done1, Elem>, Err1>) => MergeState<Env, Err, Err1, Err2, Elem, Done, Done1, Done2>;
/**
 * @since 2.0.0
 * @category constructors
 */
...
export declare const match: {
    <Env, Err, Err1, Err2, Elem, Done, Done1, Done2, Z>(options: {
        readonly onBothRunning: (left: Fiber.Fiber<Either.Either<Done, Elem>, Err>, right: Fiber.Fiber<Either.Either<Done1, Elem>, Err1>) => Z;
