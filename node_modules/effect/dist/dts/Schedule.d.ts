...
export interface Schedule<out Env, in In, out Out> extends Schedule.Variance<Env, In, Out>, Pipeable {
     ...
     * Schedule Step
     */
    step(now: number, input: In, state: any): Effect.Effect<readonly [any, Out, ScheduleDecision.ScheduleDecision], never, Env>;
}
/**
 * @since 2.0.0
 */
export declare namespace Schedule {
     ...
     * @category models
     */
    interface Variance<out Env, in In, out Out> {
     ...
     * @since 2.0.0
     */
    interface DriverVariance<out Env, in In, out Out> {
 ...
 */
export declare const makeWithState: <S, Env, In, Out>(initial: S, step: (now: number, input: In, state: S) => Effect.Effect<readonly [S, Out, ScheduleDecision.ScheduleDecision], never, Env>) => Schedule<Env, In, Out>;
/**
...
export declare const addDelayEffect: {
    <Out, Env2>(f: (out: Out) => Effect.Effect<Duration.DurationInput, never, Env2>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2>(self: Schedule<Env, In, Out>, f: (out: Out) => Effect.Effect<Duration.DurationInput, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
...
export declare const checkEffect: {
    <In, Out, Env2>(test: (input: In, output: Out) => Effect.Effect<boolean, never, Env2>): <Env>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2>(self: Schedule<Env, In, Out>, test: (input: In, output: Out) => Effect.Effect<boolean, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
 ...
 * @category utils
 */
export declare const collectUntilEffect: <Env, A>(f: (a: A) => Effect.Effect<boolean, never, Env>) => Schedule<Env, A, Chunk.Chunk<A>>;
/**
 ...
 * @since 2.0.0
 */
export declare const collectWhileEffect: <Env, A>(f: (a: A) => Effect.Effect<boolean, never, Env>) => Schedule<Env, A, Chunk.Chunk<A>>;
/**
...
export declare const mapInputEffect: {
    <In, Env2, In2>(f: (in2: In2) => Effect.Effect<In, never, Env2>): <Env, Out>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In2, Out>;
    <Env, In, Out, Env2, In2>(self: Schedule<Env, In, Out>, f: (in2: In2) => Effect.Effect<In, never, Env2>): Schedule<Env | Env2, In2, Out>;
};
/**
...
export declare const delayedEffect: {
    <Env2>(f: (duration: Duration.Duration) => Effect.Effect<Duration.DurationInput, never, Env2>): <Env, In, Out>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2>(self: Schedule<Env, In, Out>, f: (duration: Duration.Duration) => Effect.Effect<Duration.DurationInput, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
 ...
 * @category getter
 */
export declare const driver: <Env, In, Out>(self: Schedule<Env, In, Out>) => Effect.Effect<ScheduleDriver<Env, In, Out>>;
/**
...
export declare const mapEffect: {
    <Out, Env2, Out2>(f: (out: Out) => Effect.Effect<Out2, never, Env2>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out2>;
    <Env, In, Out, Env2, Out2>(self: Schedule<Env, In, Out>, f: (out: Out) => Effect.Effect<Out2, never, Env2>): Schedule<Env | Env2, In, Out2>;
};
/**
...
export declare const modifyDelayEffect: {
    <Out, Env2>(f: (out: Out, duration: Duration.Duration) => Effect.Effect<Duration.DurationInput, never, Env2>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2>(self: Schedule<Env, In, Out>, f: (out: Out, duration: Duration.Duration) => Effect.Effect<Duration.DurationInput, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
...
export declare const onDecision: {
    <Out, Env2, X>(f: (out: Out, decision: ScheduleDecision.ScheduleDecision) => Effect.Effect<X, never, Env2>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2, X>(self: Schedule<Env, In, Out>, f: (out: Out, decision: ScheduleDecision.ScheduleDecision) => Effect.Effect<X, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
...
export declare const reduceEffect: {
    <Out, Env1, Z>(zero: Z, f: (z: Z, out: Out) => Effect.Effect<Z, never, Env1>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env1 | Env, In, Z>;
    <Env, In, Out, Env1, Z>(self: Schedule<Env, In, Out>, zero: Z, f: (z: Z, out: Out) => Effect.Effect<Z, never, Env1>): Schedule<Env | Env1, In, Z>;
};
/**
...
export declare const run: {
    <In>(now: number, input: Iterable<In>): <Env, Out>(self: Schedule<Env, In, Out>) => Effect.Effect<Chunk.Chunk<Out>, never, Env>;
    <Env, In, Out>(self: Schedule<Env, In, Out>, now: number, input: Iterable<In>): Effect.Effect<Chunk.Chunk<Out>, never, Env>;
};
/**
...
export declare const tapInput: {
    <Env2, In2, X>(f: (input: In2) => Effect.Effect<X, never, Env2>): <Env, In, Out>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In & In2, Out>;
    <Env, In, Out, Env2, In2, X>(self: Schedule<Env, In, Out>, f: (input: In2) => Effect.Effect<X, never, Env2>): Schedule<Env | Env2, In & In2, Out>;
};
/**
...
export declare const tapOutput: {
    <Out, XO extends Out, Env2, X>(f: (out: XO) => Effect.Effect<X, never, Env2>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, XO extends Out, Env2, X>(self: Schedule<Env, In, Out>, f: (out: XO) => Effect.Effect<X, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
...
export declare const untilInputEffect: {
    <In, Env2>(f: (input: In) => Effect.Effect<boolean, never, Env2>): <Env, Out>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2>(self: Schedule<Env, In, Out>, f: (input: In) => Effect.Effect<boolean, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
 * Returns a new schedule that continues until the specified predicate on the
...
export declare const untilOutputEffect: {
    <Out, Env2>(f: (out: Out) => Effect.Effect<boolean, never, Env2>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env2 | Env, In, Out>;
    <Env, In, Out, Env2>(self: Schedule<Env, In, Out>, f: (out: Out) => Effect.Effect<boolean, never, Env2>): Schedule<Env | Env2, In, Out>;
};
/**
 * A schedule that recurs during the given duration.
 *
...
export declare const whileOutputEffect: {
    <Out, Env1>(f: (out: Out) => Effect.Effect<boolean, never, Env1>): <Env, In>(self: Schedule<Env, In, Out>) => Schedule<Env1 | Env, In, Out>;
    <Env, In, Out, Env1>(self: Schedule<Env, In, Out>, f: (out: Out) => Effect.Effect<boolean, never, Env1>): Schedule<Env | Env1, In, Out>;
};
/**
