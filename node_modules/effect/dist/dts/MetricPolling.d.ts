...
export declare const launch: {
    <R2, A2>(schedule: Schedule.Schedule<R2, unknown, A2>): <Type, In, R, E, Out>(self: MetricPolling<Type, In, R, E, Out>) => Effect.Effect<Fiber.Fiber<A2, E>, never, Scope.Scope | R2 | R>;
    <Type, In, R, E, Out, R2, A2>(self: MetricPolling<Type, In, R, E, Out>, schedule: Schedule.Schedule<R2, unknown, A2>): Effect.Effect<Fiber.Fiber<A2, E>, never, Scope.Scope | R | R2>;
};
/**
 * An effect that polls a value that may be fed to the metric.
 *
