...
export declare const filterOrLeft: {
    <A, B extends A, E2>(refinement: Refinement<NoInfer<A>, B>, orLeftWith: (a: NoInfer<A>) => E2): <E>(self: Either<E, A>) => Either<E2 | E, B>;
    <A, E2>(predicate: Predicate<NoInfer<A>>, orLeftWith: (a: NoInfer<A>) => E2): <E>(self: Either<E, A>) => Either<E2 | E, A>;
