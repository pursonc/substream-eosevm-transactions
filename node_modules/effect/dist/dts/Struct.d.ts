 ...
 * @since 2.0.0
 */
export declare const pick: <Keys extends PropertyKey[]>(...keys: Keys) => <S extends Record<Keys[number], any>>(s: S) => MatchRecord<S, { [K in Keys[number]]: S[K] | undefined; }, { [K_1 in Keys[number]]: S[K_1]; }>;
/**
 ...
 * @since 2.0.0
 */
export declare const omit: <Keys extends PropertyKey[]>(...keys: Keys) => <S extends Record<Keys[number], any>>(s: S) => Simplify<Omit<S, Keys[number]>>;
/**
 ...
 * @since 2.0.0
 */
export declare const get: <K extends PropertyKey>(key: K) => <S extends Record<K, any>>(s: S) => MatchRecord<S, S[K] | undefined, S[K]>;
export {};
