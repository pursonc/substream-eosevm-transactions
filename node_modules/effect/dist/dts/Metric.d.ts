...
export declare const trackDefectWith: {
    ...
    <R, E, A, Type, In, Out>(self: Effect.Effect<A, E, R>, metric: Metric<Type, In, Out>, f: (defect: unknown) => In): Effect.Effect<A, E, R>;
};
/**
...
export declare const trackDuration: {
    ...
    <R, E, A, Type, Out>(self: Effect.Effect<A, E, R>, metric: Metric<Type, Duration.Duration, Out>): Effect.Effect<A, E, R>;
};
/**
 * Returns an aspect that will update this metric with the duration that the
...
export declare const trackDurationWith: {
    ...
    <R, E, A, Type, In, Out>(self: Effect.Effect<A, E, R>, metric: Metric<Type, In, Out>, f: (duration: Duration.Duration) => In): Effect.Effect<A, E, R>;
};
/**
...
export declare const trackError: {
    <Type, In, Out>(metric: Metric<Type, In, Out>): <R, E extends In, A>(self: Effect.Effect<A, E, R>) => Effect.Effect<A, E, R>;
    <R, E extends In, A, Type, In, Out>(self: Effect.Effect<A, E, R>, metric: Metric<Type, In, Out>): Effect.Effect<A, E, R>;
};
/**
 * Returns an aspect that will update this metric with the result of applying
...
export declare const trackErrorWith: {
    <Type, In, Out, In2>(metric: Metric<Type, In, Out>, f: (error: In2) => In): <R, E extends In2, A>(effect: Effect.Effect<A, E, R>) => Effect.Effect<A, E, R>;
    <R, E extends In2, A, Type, In, Out, In2>(self: Effect.Effect<A, E, R>, metric: Metric<Type, In, Out>, f: (error: In2) => In): Effect.Effect<A, E, R>;
};
/**
...
export declare const trackSuccess: {
    <Type, In, Out>(metric: Metric<Type, In, Out>): <R, E, A extends In>(self: Effect.Effect<A, E, R>) => Effect.Effect<A, E, R>;
    <R, E, A extends In, Type, In, Out>(self: Effect.Effect<A, E, R>, metric: Metric<Type, In, Out>): Effect.Effect<A, E, R>;
};
/**
 * Returns an aspect that will update this metric with the result of applying
...
export declare const trackSuccessWith: {
    <Type, In, Out, In2>(metric: Metric<Type, In, Out>, f: (value: In2) => In): <R, E, A extends In2>(self: Effect.Effect<A, E, R>) => Effect.Effect<A, E, R>;
    <R, E, A extends In2, Type, In, Out, In2>(self: Effect.Effect<A, E, R>, metric: Metric<Type, In, Out>, f: (value: In2) => In): Effect.Effect<A, E, R>;
};
/**
