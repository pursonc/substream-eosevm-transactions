...
export declare const filter: {
    <K extends string, A, B extends A>(refinement: (a: NoInfer<A>, key: K) => a is B): (self: Record<K, A>) => Record<string, B>;
...
export declare const partition: {
    <K extends string, A, B extends A>(refinement: (a: NoInfer<A>, key: K) => a is B): (self: Record<K, A>) => [excluded: Record<string, Exclude<A, B>>, satisfying: Record<string, B>];
    <K extends string, A>(predicate: (a: NoInfer<A>, key: K) => boolean): (self: Record<K, A>) => [excluded: Record<string, A>, satisfying: Record<string, A>];
