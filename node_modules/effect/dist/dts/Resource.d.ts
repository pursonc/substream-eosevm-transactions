 ...
 */
export declare const auto: <A, E, R, R2, Out>(acquire: Effect.Effect<A, E, R>, policy: Schedule.Schedule<R2, unknown, Out>) => Effect.Effect<Resource<A, E>, never, Scope.Scope | R | R2>;
/**
