...
export declare const flatMap: {
    <A, R2, E2, A2>(f: (context: Context.Context<A>) => Layer<A2, E2, R2>): <R, E>(self: Layer<A, E, R>) => Layer<A2, E2 | E, R2 | R>;
    <R, E, A, R2, E2, A2>(self: Layer<A, E, R>, f: (context: Context.Context<A>) => Layer<A2, E2, R2>): Layer<A2, E | E2, R | R2>;
};
/**
...
export declare const match: {
    ...
    <R, E, A, R2, E2, A2, R3, E3, A3>(self: Layer<A, E, R>, options: {
        readonly onFailure: (error: E) => Layer<A2, E2, R2>;
        readonly onSuccess: (context: Context.Context<A>) => Layer<A3, E3, R3>;
...
export declare const locally: {
    ...
    <R, E, A, X>(self: Layer<A, E, R>, ref: FiberRef<X>, value: X): Layer<A, E, R>;
};
/**
 * @since 2.0.0
 * @category utils
...
export declare const retry: {
    <RIn2, E, X>(schedule: Schedule.Schedule<RIn2, E, X>): <RIn, ROut>(self: Layer<ROut, E, RIn>) => Layer<ROut, E, RIn2 | RIn>;
    <RIn, E, ROut, RIn2, X>(self: Layer<ROut, E, RIn>, schedule: Schedule.Schedule<RIn2, E, X>): Layer<ROut, E, RIn | RIn2>;
};
/**
...
export declare const scoped: {
    <T extends Context.Tag<any, any>>(tag: T): <R, E>(effect: Effect.Effect<Context.Tag.Service<T>, E, R>) => Layer<Context.Tag.Identifier<T>, E, Exclude<R, Scope.Scope>>;
    <T extends Context.Tag<any, any>, R, E>(tag: T, effect: Effect.Effect<Context.Tag.Service<T>, E, R>): Layer<Context.Tag.Identifier<T>, E, Exclude<R, Scope.Scope>>;
};
/**
 * Constructs a layer from the specified scoped effect.
 *
 ...
 * @category constructors
 */
export declare const scopedDiscard: <_, E, R>(effect: Effect.Effect<_, E, R>) => Layer<never, E, Exclude<R, Scope.Scope>>;
/**
...
export declare const zipWith: {
    <R2, E2, B, A, C>(that: Layer<B, E2, R2>, f: (a: Context.Context<A>, b: Context.Context<B>) => Context.Context<C>): <R, E>(self: Layer<A, E, R>) => Layer<C, E2 | E, R2 | R>;
    <R, E, R2, E2, B, A, C>(self: Layer<A, E, R>, that: Layer<B, E2, R2>, f: (a: Context.Context<A>, b: Context.Context<B>) => Context.Context<C>): Layer<C, E | E2, R | R2>;
};
/**
 * @since 2.0.0
 * @category utils
 */
export declare const unwrapEffect: <R, E, R1, E1, A>(self: Effect.Effect<Layer<A, E1, R1>, E, R>) => Layer<A, E | E1, R | R1>;
/**
 * @since 2.0.0
 * @category utils
 */
export declare const unwrapScoped: <R, E, R1, E1, A>(self: Effect.Effect<Layer<A, E1, R1>, E, R>) => Layer<A, E | E1, R1 | Exclude<R, Scope.Scope>>;
/**
 * @since 2.0.0
 * @category clock
 */
