...
export declare const evaluate: {
    <K, E, V, R2, E2, A>(f: (key: K, stream: Stream.Stream<V, E>) => Stream.Stream<A, E2, R2>, options?: {
        readonly bufferSize?: number | undefined;
    } | undefined): <R>(self: GroupBy<R, E, K, V>) => Stream.Stream<A, E | E2, R2 | R>;
    <R, K, E, V, R2, E2, A>(self: GroupBy<R, E, K, V>, f: (key: K, stream: Stream.Stream<V, E>) => Stream.Stream<A, E2, R2>, options?: {
        readonly bufferSize?: number | undefined;
 ...
 */
export declare const make: <R, E, K, V>(grouped: Stream.Stream<readonly [K, Queue.Dequeue<Take.Take<V, E>>], E, R>) => GroupBy<R, E, K, V>;
