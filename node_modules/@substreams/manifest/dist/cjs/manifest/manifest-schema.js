...
const InputSchema = exports.InputSchema = /*#__PURE__*/Schema.union( /*#__PURE__*/Schema.struct({
  ...
  store: Schema.string,
  mode: /*#__PURE__*/Schema.optional( /*#__PURE__*/Schema.literal("get", "deltas"), {
    default: () => "get"
  })
}));
...
const MapModuleSchema = exports.MapModuleSchema = /*#__PURE__*/Schema.struct({
  ...
  initialBlock: /*#__PURE__*/Schema.optional( /*#__PURE__*/Schema.suspend(() => InitialBlockSchema)),
  inputs: /*#__PURE__*/Schema.array(Schema.suspend(() => InputSchema)).pipe( /*#__PURE__*/Schema.minItems(1)),
  name: /*#__PURE__*/Schema.string.pipe( /*#__PURE__*/Schema.pattern(_core.nameRegExp)),
...
const BinarySchema = exports.BinarySchema = /*#__PURE__*/Schema.struct({
  file: Schema.string,
  type: /*#__PURE__*/Schema.suspend(() => BinaryTypeSchema),
...
const ManifestSchema = exports.ManifestSchema = /*#__PURE__*/Schema.struct({
  ...
  specVersion: /*#__PURE__*/Schema.suspend(() => ManifestSpecVersionSchema),
  binaries: /*#__PURE__*/Schema.optional( /*#__PURE__*/Schema.record(Schema.string, /*#__PURE__*/Schema.suspend(() => BinarySchema))),
  ...
  modules: /*#__PURE__*/Schema.array(Schema.suspend(() => ModuleSchema)).pipe( /*#__PURE__*/Schema.minItems(1)),
  package: /*#__PURE__*/Schema.suspend(() => PackageSchema),
  protobuf: /*#__PURE__*/Schema.suspend(() => ProtobufSchema),
  params: /*#__PURE__*/Schema.optional( /*#__PURE__*/Schema.record(Schema.string, Schema.string)),
  sink: /*#__PURE__*/Schema.optional( /*#__PURE__*/Schema.suspend(() => SinkSchema))
});
